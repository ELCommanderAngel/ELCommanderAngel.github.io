...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2024 a las 03:02:08
...
--
ALTER TABLE `artista`
  ADD CONSTRAINT `artista_ibfk_1` FOREIGN KEY (`id`) REFERENCES `canciones` (`id`);

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`id`) REFERENCES `generos` (`id`);
COMMIT;
